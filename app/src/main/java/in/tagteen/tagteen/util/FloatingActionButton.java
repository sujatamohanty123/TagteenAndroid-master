...
public class FloatingActionButton extends AppCompatImageButton {
  ...
  @IntDef({ SIZE_NORMAL, SIZE_MINI, SIZE_MICRO })
  ...
  private void updateCircleSize() {
    ...
    } else if (mSize == SIZE_MICRO) {
      mCircleSize = getDimension(R.dimen.fab_size_micro);
    }
  }

  public void setSize(@FAB_SIZE int size) {
    if (size != SIZE_MINI && size != SIZE_NORMAL && size != SIZE_MICRO) {
  ...
  */
  ...
  void updateBackground() {
    ...
    int resId = R.drawable.fab_bg_normal;
    if (mSize == SIZE_MINI) {
      resId = R.drawable.fab_bg_mini;
    } else if (mSize == SIZE_MICRO) {
      resId = R.drawable.fab_bg_micro;
    }
