...
public class GroupDashboardDialogAdapter  extends BaseAdapter {
        private Context mContext;
        private LayoutInflater mInflater;
        int catag_icon;

        public GroupDashboardDialogAdapter(Context c) {
...
//        this.catag_icon = catag_icon;
        ...
        public int getCount() {
            return mThumbIconsForGroups.length;
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            in.tagteen.tagteen.Adapters.GroupDashboardDialogAdapter.ViewHolder holder;
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.dialog_iteams, null);

                holder = new in.tagteen.tagteen.Adapters.GroupDashboardDialogAdapter.ViewHolder();
                ...
                holder = (in.tagteen.tagteen.Adapters.GroupDashboardDialogAdapter.ViewHolder) convertView.getTag();
            }
      ...
      /*  if(catag_icon == 1){
            ...
            holder.relativeLayout.setBackgroundResource(mThumbIds[position]);
            holder.title.setText(categoryContentInGroup[position]);
            holder.icon.setImageResource(mThumbIconsForGroups[position]);
     /*   }*/
