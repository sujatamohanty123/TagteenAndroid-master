...
/**
 * Created by WeMakeAppz_09 on 1/24/2018.
 */
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    //private HashMap<String, List<String>> child1;
    ...
    public View getChildView(int groupPosition, final int childPosition,
       ...
       // TextView child_text1 = (TextView) convertView.findViewById(R.id.child1);

        child_text.setText(childText);
     //  child_text1.setText(childText1);
        return convertView;
    }
