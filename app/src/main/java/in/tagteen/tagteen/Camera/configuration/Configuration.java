package in.tagteen.tagteen.Camera.configuration;
...
public final class Configuration implements Serializable {
  ...
  @IntDef({MEDIA_QUALITY_MEDIUM, MEDIA_QUALITY_HIGH, MEDIA_QUALITY_HIGHEST})
  ...
  public static class Builder {
     ...
     */
    public Builder setVideoDuration(
        @IntRange(from = 1000, to = Integer.MAX_VALUE) int videoDurationInMilliseconds) {
      configuration.videoDuration = videoDurationInMilliseconds;
      return this;
    }

    /**
     * @param minimumVideoDurationInMilliseconds - minimum video duration in milliseconds, used only
     * in video mode for auto quality.
     */
    public Builder setMinimumVideoDuration(
        @IntRange(from = 1000, to = Integer.MAX_VALUE) int minimumVideoDurationInMilliseconds) {
     ...
     */
    public Builder setVideoFileSize(
        @IntRange(from = 1048576, to = Long.MAX_VALUE) long videoSizeInBytes) {
    ...
    public Configuration build() throws IllegalArgumentException {
      if (configuration.mediaQuality == MEDIA_QUALITY_AUTO
          && configuration.minimumVideoDuration < 0) {
        throw new IllegalStateException(
            "Please provide minimum video duration in milliseconds to use auto quality.");
      }
