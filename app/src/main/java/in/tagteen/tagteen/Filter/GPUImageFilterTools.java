package in.tagteen.tagteen.Filter;
...
public class GPUImageFilterTools {
    ...
    public static GPUImageFilter createFilterForType(Context context, GPUImageFilterTools.FilterType type,int drawable) {
        switch (type) {
            case NORMAL:
            ...
            case TONE_CURVE:
                ...
                toneCurveFilter.setFromCurveFileInputStream(
                        context.getResources().openRawResource(in.tagteen.tagteen.R.raw.tone_cuver_sample));
                return toneCurveFilter;
            case BLEND_DIFFERENCE:
                return createBlendFilter(context, GPUImageDifferenceBlendFilter.class ,drawable);
            case BLEND_SOURCE_OVER:
                return createBlendFilter(context, GPUImageSourceOverBlendFilter.class,drawable);
            case BLEND_COLOR_BURN:
                return createBlendFilter(context, GPUImageColorBurnBlendFilter.class,drawable);
            case BLEND_COLOR_DODGE:
                return createBlendFilter(context, GPUImageColorDodgeBlendFilter.class,drawable);
            case BLEND_DARKEN:
                return createBlendFilter(context, GPUImageDarkenBlendFilter.class,drawable);
            case BLEND_DISSOLVE:
                return createBlendFilter(context, GPUImageDissolveBlendFilter.class,drawable);
            case BLEND_EXCLUSION:
                return createBlendFilter(context, GPUImageExclusionBlendFilter.class,drawable);


            case BLEND_HARD_LIGHT:
                return createBlendFilter(context, GPUImageHardLightBlendFilter.class,drawable);
            case BLEND_LIGHTEN:
                return createBlendFilter(context, GPUImageLightenBlendFilter.class,drawable);
            case BLEND_ADD:
                return createBlendFilter(context, GPUImageAddBlendFilter.class,drawable);
            case BLEND_DIVIDE:
                return createBlendFilter(context, GPUImageDivideBlendFilter.class,drawable);
            case BLEND_MULTIPLY:
                return createBlendFilter(context, GPUImageMultiplyBlendFilter.class,drawable);
            case BLEND_OVERLAY:
                return createBlendFilter(context, GPUImageOverlayBlendFilter.class,drawable);
            case BLEND_SCREEN:
                return createBlendFilter(context, GPUImageScreenBlendFilter.class,drawable);
            case BLEND_ALPHA:
                return createBlendFilter(context, GPUImageAlphaBlendFilter.class,drawable);
            case BLEND_COLOR:
                return createBlendFilter(context, GPUImageColorBlendFilter.class,drawable);
            case BLEND_HUE:
                return createBlendFilter(context, GPUImageHueBlendFilter.class,drawable);
            case BLEND_SATURATION:
                return createBlendFilter(context, GPUImageSaturationBlendFilter.class,drawable);
            case BLEND_LUMINOSITY:
                return createBlendFilter(context, GPUImageLuminosityBlendFilter.class,drawable);
            case BLEND_LINEAR_BURN:
                return createBlendFilter(context, GPUImageLinearBurnBlendFilter.class,drawable);
            case BLEND_SOFT_LIGHT:
                return createBlendFilter(context, GPUImageSoftLightBlendFilter.class,drawable);
            case BLEND_SUBTRACT:
                return createBlendFilter(context, GPUImageSubtractBlendFilter.class,drawable);
            case BLEND_CHROMA_KEY:
                return createBlendFilter(context, GPUImageChromaKeyBlendFilter.class,drawable);
            case BLEND_NORMAL:
                return createBlendFilter(context, GPUImageNormalBlendFilter.class,drawable);

            case LOOKUP_AMATORKA:
                GPUImageLookupFilter amatorka = new GPUImageLookupFilter();
                amatorka.setBitmap(BitmapFactory.decodeResource(context.getResources(), in.tagteen.tagteen.R.drawable.lookup_amatorka));
                return amatorka;
            case GAUSSIAN_BLUR:
    ...
    private static GPUImageFilter createBlendFilter(Context context, Class<? extends GPUImageTwoInputFilter> filterClass,int drawable) {
        try {
            GPUImageTwoInputFilter filter = filterClass.newInstance();
            filter.setBitmap(BitmapFactory.decodeResource(context.getResources(),drawable));
            return filter;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    public interface OnGpuImageFilterChosenListener {
        void onGpuImageFilterChosenListener(GPUImageFilter filter,int percent);
    }
