...
public class WebShowsAdapter extends RecyclerView.Adapter<WebShowsAdapter.ViewHolder> {
    private Context mContext;
    private ArrayList<WebshowModel.WebshowDetails> postsList;
    private int webshowTypeId;

    public WebShowsAdapter(
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        return new ViewHolder(LayoutInflater.from(
                parent.getContext()).inflate(R.layout.webshows_video_row, parent, false));
    }
    ...
    private void moveToDetailsScreen(WebshowModel.WebshowDetails data) {
        ...
        bundle.putInt(Constants.WEBSHOW_TYPE_ID, this.webshowTypeId);
