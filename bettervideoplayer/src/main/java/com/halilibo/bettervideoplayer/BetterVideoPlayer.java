...
public class BetterVideoPlayer extends RelativeLayout implements IUserMethods,
    ...
    private TextView  viewForward, viewBackward;
    ...
    private ProgressBar videobuffuring;
    ...
    protected void onFinishInflate() {
        ...
        videobuffuring=(ProgressBar)mTextureFrame.findViewById(R.id.videobuffuring);
        ...
        // Inflate controls
        mControlsFrame = li.inflate(R.layout.player_controls, this, false);
    ...
    public void setLoaderVisiblity(int visiblity){
        if(videobuffuring!=null){
            videobuffuring.setVisibility(visiblity);
        }
    }
}
