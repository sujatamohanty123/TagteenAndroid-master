...
public abstract class JZVideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public TextView currentTimeTextView, totalTimeTextView,textMuteUnmute;
    ...
    public CallBackListner mCallBackListner;

    public interface CallBackListner {
        public void onCompleteListener(MediaPlayer mediaPlayer);
    }

    public void setListener(CallBackListner listener) {
        mCallBackListner = listener;
    }
...
//            jzVideoPlayer.setAnimation(ra);
    ...
    public void init(final Context context) {
        ...
        textMuteUnmute=(TextView)findViewById(R.id.textMuteUnmute);
        ...
        textMuteUnmute.setOnTouchListener(this);
        ...
        JZMediaManager.instance().setListener(new JZMediaManager.Listener() {
            @Override
            public void onCompleteListener(MediaPlayer mediaPlayer) {
                mCallBackListner.onCompleteListener(mediaPlayer);
            }
        });
    }
